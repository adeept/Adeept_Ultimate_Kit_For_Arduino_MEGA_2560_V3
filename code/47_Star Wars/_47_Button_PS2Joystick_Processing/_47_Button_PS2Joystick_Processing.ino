/***********************************************************
File name:   47_Button_PS2Joystick_Processing.ino
...
Date: 2019/02/19 
***********************************************************/
int xpotPin = 0; // Define UNO board A0 pin connect the Joystick x
int ypotPin = 1; // Define UNO board A1 pin connect the Joystick y
